...
const ProjectShowcaseSection: React.FC<ProjectShowcaseSectionProps> = ({ projects }) => {
  ...
  const projectActions = [
    { text: "View", action: (project: Project) => handleProjectAction(project, "View") },
    { text: "Explore", action: (project: Project) => handleProjectAction(project, "Explore") },
    { text: "Play", action: (project: Project) => handleProjectAction(project, "Play") }
  ];
      ...
      <div className="flex flex-col gap-20">
        ...
        {selectedProject && (
          <div className="mt-8 p-6 bg-(--color-muted) rounded-lg max-w-2xl mx-auto">
            <h3 className="text-lg font-semibold mb-2">Project Selected: {selectedProject.title}</h3>
